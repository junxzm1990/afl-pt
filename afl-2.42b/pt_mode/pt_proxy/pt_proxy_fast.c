...
#define TWENTYFOUR_BIT_ENTRIES (1<<24)                       /* num of keys in the rand_map     */
/* #define RAND_MAP_SIZE TWENTYFOUR_BIT_ENTRIES                 /\* size of the rand_map            *\/ */
/* #define RAND_MAP_SIZE TWENTY_BIT_ENTRIES                 /\* size of the rand_map            *\/ */
#define RAND_MAP_SIZE TWO_BYTE_ENTRIES                 /* size of the rand_map            */
u64 rand_map[RAND_MAP_SIZE];                           /* maps u16 val to random value UR()*/
