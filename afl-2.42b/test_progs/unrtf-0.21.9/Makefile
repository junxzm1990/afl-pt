...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in COPYING config/config.guess \
...
STRIP = 
VERSION = 0.21.9
abs_builddir = /src/local/cmd/unrtf/hg/unrtf
abs_srcdir = /src/local/cmd/unrtf/hg/unrtf
abs_top_builddir = /src/local/cmd/unrtf/hg/unrtf
abs_top_srcdir = /src/local/cmd/unrtf/hg/unrtf
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
SUBDIRS = src tests doc patches outputs

# then do stuff in this directory. Actually, we just need to add the
# bootstrap script to the distribution (for curious users, not really needed).
